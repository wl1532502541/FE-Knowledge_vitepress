...
<template>
  <header v-if="showHero" class="home-hero">
    ...
    <div v-if="frontmatter.tagline" class="description">
      <div class="hello-world">
        {{ frontmatter.tagline }}
      </div>
    </div>

    <NavLink v-if="frontmatter.actionLink && frontmatter.actionText" :item="{ link: frontmatter.actionLink, text: frontmatter.actionText }" class="action" />

    <NavLink v-if="frontmatter.altActionLink && frontmatter.altActionText" :item="{
